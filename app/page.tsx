...
export default function Home() {
    ...
    const handleSendMessage = async () => {
        ...
        if (
            ...
            addMessage(
                "I'll generate your medical record now. You can view it in the medical record section that just appeared. This record includes all the information we've discussed and my recommendations.",
                "ai"
            );
            setIsLoading(false);
            return;
            ...
            <div className="container mx-auto px-4 py-8">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-300 text-lg">
                        Secure Medical History Collection & Health Consultation
                    </p>
                ...
                <div className="grid grid-cols-1 xl:grid-cols-5 gap-8">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-blue-100 text-sm">
                                            Ask questions, share symptoms, or
                    ...
                    <div className="xl:col-span-2 space-y-6 order-2">
                        ...
                        {showUserSearch && !selectedUser && (
                            <GetUserById onUserFound={handleUserFound} />
                        )}
                        ...
                        {userReports.length > 0 && (
                            <div className="bg-gray-800/90 backdrop-blur-sm rounded-2xl shadow-2xl border border-gray-700/50 p-6">
                                <h3 className="text-xl font-semibold text-white mb-4 flex items-center">
                                    ...
                                    Medical Reports for {selectedUser?.name}
                                </h3>
                        ...
                        <div className="bg-yellow-500/10 border border-yellow-500/30 rounded-2xl p-6 backdrop-blur-sm">
                            ...
                            <p className="text-sm text-yellow-300/80">
                                ...
                                treatment. Always consult qualified healthcare
